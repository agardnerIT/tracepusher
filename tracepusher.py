...
def print_help_text():
   ...
   print("Optional parameter: '--shift'. If provided, will shift start and end time BACK in time by <SPAN_TIME_IN_SECONDS> seconds.")
   print("Please ensure this is teh LAST parameter you use. eg. tracepusher.py ... OTHER PARAMS ... --shift")
   print("This is useful if you want to call tracepusher after a time-sensitive event has occured (eg. tracing shell scripts)")
   print("eg. python tracepusher.py http://localhost:4318 tracepusher my-span 2 --shift")
...
TIME_SHIFT = False
if "--shift" in sys.argv or "--shift=true" in sys.argv:
  print("> Optional parameter detected. Will shift the start and end time back in time by SPAN_TIME_IN_SECONDS.")
  TIME_SHIFT = True
...
duration_nanos = trace_length_seconds * 1000000000
# get time now
time_now = time.time_ns()
# calculate future time by adding that many seconds
time_future = time_now + duration_nanos

# shift time_now and time_future back by (trace_length_seconds * 
if TIME_SHIFT:
