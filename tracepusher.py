...
# curl -i -X POST http://otel_collector_url/v1/traces \
# -H "Content-Type: application/json" \
# -d @trace.json

#############################################################################
# USAGE
# python tracepusher.py http://localhost:4318 service-name-A spanX 2
#############################################################################

def print_help_text():
   print("Random trace and span IDs are automatically generated by this tool")
   print("Usage: python tracepusher.py http://OTEL-COLLECTOR-ENDPOINT-AND-PORT service_name span_name SPAN_TIME_IN_SECONDS")
